...
void setup() 
{
  ...
  Servo_2.attachPin(PIN_UpperLeg, PWM_FREQ, PWM_RES);
  Servo_3.attachPin(PIN_UpperLeg, PWM_FREQ, PWM_RES);
  Servo_4.attachPin(PIN_UpperLeg, PWM_FREQ, PWM_RES);
  Servo_5.attachPin(PIN_UpperLeg, PWM_FREQ, PWM_RES);
